...
The regression shows a negative trend, indicating that obesity and green space percentages are inversely related. On average, counties with lower access to green space access, tend to have higher obesity rates. However, this analysis is limited due to potential confounders such as the impact of the COVID-19 Pandemic. During the pandemic, many people spent more time indoors, which could have decreased the use of available green spaces and contributed to higher obesity rates through low physical activity or changes in earing habits. As a result, the observed relationship may reflect pandemic-related behavioral changes rather than the influence of green space alone.
